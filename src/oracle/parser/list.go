...
//
// Many productions carry it, and each hand-written copy would be another chance to admit
// `[10 20]`, which is exactly the defect R263 had to fix in the grammar across several
